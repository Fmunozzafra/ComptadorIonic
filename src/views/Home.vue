...
import {
  ...
  IonToolbar,
  IonIcon,
  alertController, IonGrid, IonRow, IonCol, toastController
} from '@ionic/vue';
    ...
    async info() {
      const alert = await alertController
          .create({
            ...
            subHeader: 'Creat per Ferran Muñoz Zafra',
            message: 'Podeu trobar el codi font a: <a href="https://github.com/Fmunozzafra/ComptadorIonic">https://github.com/acacha/ComptadorIonic</a>',
            buttons: ['OK'],
          });
      await alert.present();
    },
